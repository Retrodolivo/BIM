...
#SPI configuraton
def ad4020_spi_init(port, mode, cs, speed):
...
if __name__ == "__main__":
    ...
    ad4020_spi.mode = 0
    ad4020_spi.max_speed_hz = 2000000    

    button_config = tk.Button(win, text = "Config", command = ad4020_config)
    button_config.bind("<Button-1>")

    button_read = tk.Button(win, text = "Read", command = ad4020_read)
